...
const PrivacyEn = () => {
  return (
    ...
    <div className="privacy_privacyInfo">
      ...
      <p>At OnlineCloathsCas.com, we prioritize your privacy and the security of your information. This document outlines our commitment to safeguarding your data and explains the practices you agree to by using our services and website.</p>
      ...
      <p>For inquiries or more information about our privacy practices, please contact us at <a href="mailto:info@onlinecloathscas.com">info@onlinecloathscas.com</a> or using number +48 22 827 73 82. We are dedicated to promptly addressing your concerns and protecting your privacy rights.</p>
    </div>
    <Footer2/>
    </>
  );
