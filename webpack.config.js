...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      filename: 'index.html',
      chunks: ['index'],
      title: 'TotalClothesOnline.com - Home',
    ...
    new HtmlWebpackPlugin({
      ...
      chunks: ['contact'],
      title: 'TotalClothesOnline.com - Contact Us',
      favicon: './public/favicon.png',
    }),
    new HtmlWebpackPlugin({
      template: './public/template.html',
      filename: 'terms.html',
      chunks: ['terms'],
      title: 'TotalClothesOnline.com - Terms of Service',
      favicon: './public/favicon.png',
    }),
    new HtmlWebpackPlugin({
      template: './public/template.html',
      ...
      chunks: ['privacy'],
      title: 'TotalClothesOnline.com - Privacy Policy',
      favicon: './public/favicon.png',
    }),
    new HtmlWebpackPlugin({
      template: './public/template.html',
      ...
      chunks: ['thankyou'],
      title: 'TotalClothesOnline.com - Thank You',
      favicon: './public/favicon.png',
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      chunks: ['en/contact'],
      title: 'TotalClothesOnline.com - Contact Us (EN)',
      favicon: './public/favicon.png',
    }),
    new HtmlWebpackPlugin({
      template: './public/template-en.html',
      ...
      chunks: ['en/terms'],
      title: 'TotalClothesOnline.com - Terms of Service (EN)',
      favicon: './public/favicon.png',
    }),
    new HtmlWebpackPlugin({
      template: './public/template-en.html',
      ...
      chunks: ['en/privacy'],
      title: 'TotalClothesOnline.com - Privacy Policy (EN)',
      favicon: './public/favicon.png',
    }),
    new HtmlWebpackPlugin({
      template: './public/template-en.html',
      ...
      chunks: ['en/thankyou'],
      title: 'TotalClothesOnline.com - Thank You (EN)',
      favicon: './public/favicon.png',
    }),
  ],
  module: {
